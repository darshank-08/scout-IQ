              ...
              <ul className={styles.navList}>
                <li>
                  <button className={`${styles.navBtn} ${styles.active}`}>
                    <img src="./assets/PL.jpg" alt="" className={styles.PL}/>
                    <span>Leagues</span>
                  </button>
                </li>
                <li>
                  <button className={styles.navBtn}>
                    <img src="./assets/Brasil.jpg" alt="" className={styles.CNTSvg}/>
                    <span>Countries</span>
                  </button>
                </li>
              </ul>
